...
import type {
  RequestResponse,
  RequestResponseOfPagedResponseOfUserFileRecord,
} from '../models/index';
import {
    RequestResponseFromJSON,
    RequestResponseToJSON,
    RequestResponseOfPagedResponseOfUserFileRecordFromJSON,
    RequestResponseOfPagedResponseOfUserFileRecordToJSON,
} from '../models/index';
...
export class UserFileApi extends runtime.BaseAPI {
    ...
    /**
     */
    async apiUserFileGetPageGetRaw(requestParameters: ApiUserFileGetPageGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestResponseOfPagedResponseOfUserFileRecord>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RequestResponseOfPagedResponseOfUserFileRecordFromJSON(jsonValue));
    }

    /**
     */
    async apiUserFileGetPageGet(requestParameters: ApiUserFileGetPageGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RequestResponseOfPagedResponseOfUserFileRecord> {
