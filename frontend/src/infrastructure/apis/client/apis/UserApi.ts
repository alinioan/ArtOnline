...
import type {
  RequestResponse,
  RequestResponseOfPagedResponseOfUserRecord,
  RequestResponseOfUserRecord,
  UserAddRecord,
  UserUpdateRecord,
} from '../models/index';
import {
    ...
    RequestResponseOfPagedResponseOfUserRecordFromJSON,
    RequestResponseOfPagedResponseOfUserRecordToJSON,
    RequestResponseOfUserRecordFromJSON,
    RequestResponseOfUserRecordToJSON,
...
export class UserApi extends runtime.BaseAPI {
    ...
    async apiUserAddPostRaw(requestParameters: ApiUserAddPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestResponse>> {
        if (requestParameters['userAddRecord'] == null) {
            throw new runtime.RequiredError(
                'userAddRecord',
                'Required parameter "userAddRecord" was null or undefined when calling apiUserAddPost().'
            );
        }
    ...
    /**
     */
    async apiUserGetByIdIdGetRaw(requestParameters: ApiUserGetByIdIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestResponseOfUserRecord>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RequestResponseOfUserRecordFromJSON(jsonValue));
    }

    /**
     */
    async apiUserGetByIdIdGet(requestParameters: ApiUserGetByIdIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RequestResponseOfUserRecord> {
    ...
    /**
     */
    async apiUserGetPageGetRaw(requestParameters: ApiUserGetPageGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestResponseOfPagedResponseOfUserRecord>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RequestResponseOfPagedResponseOfUserRecordFromJSON(jsonValue));
    }

    /**
     */
    async apiUserGetPageGet(requestParameters: ApiUserGetPageGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RequestResponseOfPagedResponseOfUserRecord> {
    ...
    async apiUserUpdatePutRaw(requestParameters: ApiUserUpdatePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestResponse>> {
        if (requestParameters['userUpdateRecord'] == null) {
            throw new runtime.RequiredError(
                'userUpdateRecord',
                'Required parameter "userUpdateRecord" was null or undefined when calling apiUserUpdatePut().'
            );
        }
