...
namespace ArtOnline.Infrastructure.Errors;
...
public static class CommonErrors
{
    ...
    public static ErrorMessage UserAlreadyExists => new(HttpStatusCode.Conflict, "User already exists!", ErrorCodes.EntityAlreadyExists);
